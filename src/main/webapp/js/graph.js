...
function createTriangle(R) {
    ...
    let p3 = board.create('point', [0, R/2], {name: '', size: 2, fixed: true});
...
function createRectangle(R) {
    ...
    let p4 = board.create('point', [R/2, 0], {name: '', size: 2, fixed: true});
...
function createCircle(R) {
    ...
    let p2 = board.create('point', [-R, 0], {name: '', size: 2, fixed: true, visible: false})
    let p3 = board.create('point', [0, -R], {name: '', size: 2, fixed: true, visible: false})
